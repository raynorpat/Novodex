...
//	virtual	NxShape**				getStaticShapes() = 0;
	...
	*/
	...
	Note: Make certain that the direction vector of NxRay is normalized.
	*/
	virtual NxShape*				raycastClosestBounds	(const NxRay& worldRay, NxShapesType shapeType, NxVec3* worldImpact=NULL, NxF32* dist=NULL, NxU32 groups=0xffffffff) const = 0;
	...
	Note: Make certain that the direction vector of NxRay is normalized.
	*/
	virtual NxShape*				raycastClosestShape		(const NxRay& worldRay, NxShapesType shapeType, NxVec3* worldImpact=NULL, NxF32* dist=NULL, NxU32 groups=0xffffffff) const = 0;
