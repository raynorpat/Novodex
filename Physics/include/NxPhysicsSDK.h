...
enum NxParameter
	...
	NX_MIN_SEPARATION_FOR_PENALTY,	//!< The minimum contact separation value in order to apply a penalty force. (range: [MAX_SEPARATION_FOR_PENALTY, 0]) I.e. This must be negative!!  Default: -0.05
	...
	Note: To see any visualization, you have to set VISUALIZATION_SCALE to nonzero first.
	*/
	...
	NX_VISUALIZE_COLLISION_COMPOUNDS,	//!< Compound visualization
