 ...
 * upstream: External/opcode/upstream/Opcode/OPC_Settings.h
 *
 * [1] OPC_RAYHIT_CALLBACK switched off. Stock 1.3 ships it defined.
 *     established at 0x000b5770 RayCollider::ValidateSettings returns BOTH messages that
 *     OPC_RayCollider.cpp:240-243 guards with #ifndef -- .rdata:0x0011b6b8
 *     "Closest hit doesn't work with First contact mode!" at 0x000b57ab and
 *     .rdata:0x0011b67c "Temporal coherence can't guarantee to report closest
 *     hit!" at 0x000b57b9. Independently, 0x000b5770 reads mMaxDist at
 *     this+0x84, which only the callback-off layout produces; with the define
 *     on it would be at +0x88.
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
//	#define OPC_RAYHIT_CALLBACK		// NOVODEX: switched off, see [1]
